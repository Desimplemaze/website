	  	...
	  	<div class="limit">
		  	<div class = "text-float-left">
				...
				<ul>
					...
					<li>Became proficient with using RequireJs and underscore templates</li>
				...
				<ul>
					<li>Leveraged HTML, CSS, Dojo, PUMA, VMM, LDAP</li>
					<li>Became Proficient with portlet development</li>
					<li>Familiar with Active Directory</li>
					<li>Environment: Websphere Portal 8.0, Rational Application Developer (RAD)</li>
				</ul>
				<br>
				<br>
				<br>
				...
				<br>
				<h2><b>Education</b></h2>
				<p><b>Bachelor of Science: Degree in Computer Science</b></p>
				<p>Stony Brook University, Stony Brook, NY</p>
				<br>
				<p><b>Bachelor of Science: Degree in Applied Math and Statistics</b></p>
				<p>Stony Brook University, Stony Brook, NY</p>
			</div>
		</div>
	</div>
